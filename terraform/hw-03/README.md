...
### Задание 2.1
#### Ответ
Для выполнения условия задания был создан файл `locals.tf`. В коде используется конструкция index + 1 позволяет получить имена web-1 и web-2, а не web-0 и web-1. Так в код файла была добавлена функция file для считывания ключа ~/.ssh/id_rsa.pub.
конструкция 
```text
web_vm_names = [
